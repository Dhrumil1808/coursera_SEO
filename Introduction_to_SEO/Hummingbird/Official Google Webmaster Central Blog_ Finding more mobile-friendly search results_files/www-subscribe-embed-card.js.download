...
function r(a,b){var c=a.split("."),d=k;c[0]in d||!d.execScript||d.execScript("var "+c[0]);for(var e;c.length&&(e=c.shift());)c.length||void 0===b?d[e]?d=d[e]:d=d[e]={}:d[e]=b}
...
var E=C(A,"gapi",{});var Qa=window.yt&&window.yt.config_||window.ytcfg&&window.ytcfg.data_||{};r("yt.config_",Qa);r("yt.tokens_",window.yt&&window.yt.tokens_||{});var Ra=window.yt&&window.yt.msgs_||l("window.ytcfg.msgs")||{};r("yt.msgs_",Ra);var F;F=C(A,"___jsl",D());C(F,"I",0);C(F,"hel",10);function Sa(){var a=La.href,b;if(F.dpo)b=F.h;else{b=F.h;var c=RegExp("([#].*&|[#])jsh=([^&#]*)","g"),d=RegExp("([?#].*&|[?#])jsh=([^&#]*)","g");if(a=a&&(c.exec(a)||d.exec(a)))try{b=decodeURIComponent(a[2])}catch(e){}}return b}
function Ta(a){var b=C(F,"PQ",[]);F.PQ=[];var c=b.length;if(0===c)a();else for(var d=0,e=function(){++d===c&&a()},f=0;f<c;f++)b[f](e)}
function Ua(a){return C(C(F,"H",D()),a,D())}
;var J=C(F,"perf",D());C(J,"g",D());var Va=C(J,"i",D());C(J,"r",[]);D();D();function K(a,b,c){b&&0<b.length&&(b=Wa(b),c&&0<c.length&&(b+="___"+Wa(c)),28<b.length&&(b=b.substr(0,28)+(b.length-28)),c=b,b=C(Va,"_p",D()),C(b,c,D())[a]=(new Date).getTime(),b=J.r,"function"===typeof b?b(a,"_p",c):b.push([a,"_p",c]))}
function Wa(a){return a.join("__").replace(/\./g,"_").replace(/\-/g,"_").replace(/\,/g,"_")}
;var Xa=D(),L=[];function M(a){throw Error("Bad hint"+(a?": "+a:""));}
...
var Ya=/^(\/[a-zA-Z0-9_\-]+)+$/,Za=/^[a-zA-Z0-9\-_\.,!]+$/,$a=/^gapi\.loaded_[0-9]+$/,ab=/^[a-zA-Z0-9,._-]+$/;function bb(a,b,c,d){var e=a.split(";"),f=e.shift(),g=Xa[f],h=null;g?h=g(e,b,c,d):M("no hint processor for: "+f);h||M("failed to generate load url");b=h;c=b.match(cb);(d=b.match(db))&&1===d.length&&eb.test(b)&&c&&1===c.length||M("failed sanity: "+a);return h}
...
function gb(a){"/"!==a.charAt(0)&&M("relative path");for(var b=a.substring(1).split("/"),c=[];b.length;){a=b.shift();if(!a.length||0==a.indexOf("."))M("empty/relative directory");else if(0<a.indexOf("=")){b.unshift(a);break}c.push(a)}a={};for(var d=0,e=b.length;d<e;++d){var f=b[d].split("="),g=decodeURIComponent(f[0]),h=decodeURIComponent(f[1]);2==f.length&&g&&h&&(a[g]=a[g]||h)}b="/"+c.join("/");Ya.test(b)||M("invalid_prefix");c=O(a,"k",!0);d=O(a,"am");e=O(a,"rs");a=O(a,"t");return{D:b,version:c,
o:d,A:e,C:a}}
...
var eb=/^https?:\/\/[a-z0-9_.-]+\.google\.com(:\d+)?\/[a-zA-Z0-9_.,!=\-\/]+$/,db=/\/cb=/g,cb=/\/\//g;function ib(){var a=Sa();if(!a)throw Error("Bad hint");return a}
Xa.m=function(a,b,c,d){(a=a[0])||M("missing_hint");return"https://apis.google.com"+fb(a,b,c,d)};
...
function pb(a,b,c){qb(function(){var c;c=b===Sa()?C(E,"_",D()):D();c=C(Ua(b),"_",c);a(c)},c)}
...
a=Pa(a)||[];var e=b.callback,f=b.config,g=b.timeout,h=b.ontimeout,n=b.onerror,G=void 0;"function"==typeof n&&(G=n);var H=null,N=!1;if(g&&!h||!g&&h)throw"Timeout requires both the timeout parameter and ontimeout parameter to be set";var n=C(Ua(c),"r",[]).sort(),I=C(Ua(c),"L",[]).sort(),U=[].concat(n);0<g&&(H=A.setTimeout(function(){N=!0;h()},g));
var w=kb(a,I);if(w.length){var w=kb(a,n),y=C(F,"CP",[]),z=y.length;y[z]=function(a){function b(){var a=y[z+1];a&&a()}
function c(b){y[z]=null;d(w,a)&&Ta(function(){e&&e();b()})}
...
var R;function Db(){var a=k.Promise;if(-1!=String(a).indexOf("[native code]")){var b=a.resolve(void 0);R=function(){b.then(Gb)}}else R=function(){var a=Gb;
